...
import {UserLogo, PassLogo} from './LogoIcon';
...
const SignInForm = (props : SignInFormProps) => {
    ...
    // Состояния для UI: ошибки и статуса загрузки
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) { // Если HTTP-статус ответа 2xx (например, 200 OK)
                ...
                props.handleSignInSuccess(true);
                ...
                function setCookie(name: string, value: string, days?: number): void {
                    ...
                    // Здесь добавляем secure и SameSite
                    // Обратите внимание на необходимость кодирования значения куки, если оно содержит спецсимволы
