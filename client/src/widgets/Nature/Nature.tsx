  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    useEffect(() => {
        const getNature = async () => {
            try {
                const response = await fetch(`${API_BASE_URL}api/nature`); 
  ...
  return (
    <div className="nature-container">
      <div className="nature-content-wrapper">
        <h1 className="nature-heading">Лента природы</h1>
                      ...
                      <div className="news-time">
                        {newsItem.uploaded_at && !isNaN(new Date(newsItem.uploaded_at).getTime())
                          ...
                          : ' --:-- '}
                            ...
                            <Link to={`/nature/${newsItem.id}`} className="news-title-link">
